...
const byte displayDataBufferSize       		= 70;		// Size of display data buffer
const byte displayDataBits             		= 70;       // 0-38 bits length of display data within a cycle
const byte buttonDataBits              		= 6;        // 0-2 bits length of button data within a cycle
const byte totalDataBits               		= 76;       // 0-41 total number of pulses within a cycle
