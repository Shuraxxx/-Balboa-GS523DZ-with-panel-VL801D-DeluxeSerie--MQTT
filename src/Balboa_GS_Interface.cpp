...
bool BalboaInterface::writeBlober;
...
void BalboaInterface::decodeDisplayData() {
      ...
      for (int x = 0; x <= displayDataBits; x++) {
                  ...
                  if ( x > 0 && x <= 7 ) {
                        ...
                        if ( displayDataBuffer[x] == 1){
                            displayStandartMode = true;
                        }
                        else displayStandartMode = false;
                  } 
				  else if (x == 60) {
                        if ( displayDataBuffer[x] == 1){
                            displayEcoMode = true;
            ...
            if (digitalRead(clockPin) == HIGH) {
                  ...
                  if (writeDisplayData == true && clockBitCounter >= 72 && clockBitCounter <= 75){
                          ...
                          if (clockBitCounter == 72) {
                                  ...
                                  else if (writeBlober)     { digitalWrite(buttonPin,HIGH); }
                          }
                                  ...
                                  else if (writeBlober)     { digitalWrite(buttonPin,LOW);}
                          }
