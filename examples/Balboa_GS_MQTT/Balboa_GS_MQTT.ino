...
//Constants
const char *wifi_ssid                    = "shmakovy_garden";          // WiFi SSID
const char *wifi_pwd                     = "shmakov1234567890";          // WiFi Password 
const char *wifi_hostname                = "SPA";
const char* mqtt_server                  = "192.168.1.114";           // MQTT Boker IP, your home MQTT server eg Mosquitto on RPi, or some public MQTT
...
const char *mqtt_pwd                     = "eegoB8ius2equei2nee4foh1paephoolahpaethoo6ohLee5nad2roox4ietizah";          // MQTT Broker Password 
