...
//Constants
const char *wifi_ssid                    = "wi-fi";          // WiFi SSID
const char *wifi_pwd                     = "password";          // WiFi Password 
const char *wifi_hostname                = "SPA";
const char* mqtt_server                  = "IP Adress";           // MQTT Boker IP, your home MQTT server eg Mosquitto on RPi, or some public MQTT
...
const char *mqtt_pwd                     = "password mqtt";          // MQTT Broker Password 
